  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl font-bold font-display">Bon retour !</h1>
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-accent/30 rounded-full blur-3xl animate-float delay-300" />
        ...
        <div className="relative z-10 flex items-center justify-center w-full p-12">
          <div className="glass-card p-8 max-w-md text-center">
            ...
            <p className="text-muted-foreground">
              Rejoignez une communauté de passionnés et transformez votre vie avec des coachs certifiés.
            </p>
          </div>
        </div>
      </div>
